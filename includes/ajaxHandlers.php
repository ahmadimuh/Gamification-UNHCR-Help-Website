...
function get_un_stage_by_id_callback() {
	...
	// cookie survey set
	$info_done = isset($_COOKIE['unhcr_help_ir_gamification_info']) && $_COOKIE['unhcr_help_ir_gamification_info'] === 'true';
    ...
    if ($video_type=='youtube') {
        ...
        echo "<iframe src='$content' width='100%' height='315' allowfullscreen></iframe>";
...
<div class="game-message">تصاویر با موضوع مشابه را انتخاب کنید</div>
