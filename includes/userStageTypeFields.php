...
function un_stage_type_meta_callback($post) {
    ...
    echo '<input type="text" name="un_stage_char1_text1" value="' . esc_attr($char1_text1) . '" style="width:100%"><br>';
    ...
    echo '<input type="text" name="un_stage_char2_text1" value="' . esc_attr($char2_text1) . '" style="width:100%"><br>';
...
add_action('save_post_un_stage', function ($post_id) {
    ...
    update_post_meta($post_id, '_un_stage_game_embed', wp_kses_post($_POST['un_stage_game_embed'] ?? ''));
    ...
    update_post_meta($post_id, '_un_stage_char1_text1', sanitize_text_field($_POST['un_stage_char1_text1'] ?? ''));
    ...
    update_post_meta($post_id, '_un_stage_char2_text1', sanitize_text_field($_POST['un_stage_char2_text1'] ?? ''));
...
// افزودن فیلد URL تصویر هنگام افزودن دسته جدید
...
// افزودن فیلد URL تصویر هنگام ویرایش دسته
...
// ذخیره URL تصویر هنگام ایجاد یا ویرایش دسته
add_action('created_un_flow_category', 'un_save_category_image_url');
add_action('edited_un_flow_category', 'un_save_category_image_url');
function un_save_category_image_url($term_id) {
